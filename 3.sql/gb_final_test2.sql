...
VALUES
(1, 1, 'Белка', '2023-07-15', 'Сидеть, Лежать, Голос'),
(1, 1, 'Стрелка', '2022-03-16', 'Голос, Домой, Забота'),
(1, 1, 'Рыжик', '2020-02-17', 'Охранять, Прятатья');
...
nick_name VARCHAR(50),
birthdate DATE,
command VARCHAR(50) DEFAULT 'эта кошка не подчиняется никому)'
);

INSERT INTO cat (animal_id, pet_id, nick_name, birthdate, command) 
VALUES
(1, 2, 'Кузя', '2023-05-15', 'Кушать, Спать'),
(1, 2, 'Дымок', '2022-01-16', 'Домой, Мурлыкать '),
(1, 2, 'Босс', '2020-12-17', DEFAULT);
...
nick_name VARCHAR(50),
birthdate DATE,
command VARCHAR(50) DEFAULT 'Хомяки не знают команд'
);

INSERT INTO hamster (animal_id, pet_id, nick_name, birthdate, command) 
VALUES
(1, 3, 'Лежибока', '2023-01-15', 'Прятаться'),
(1, 3, 'Дуня', '2021-09-13', 'Крутиться'),
(1, 3, 'Генриета', '2022-12-11', 'Вертеться');
...
VALUES
(2, 1, 'Пуля', '2022-02-15', 'Вперёд'),
(2, 1, 'Ракета', '2021-07-13', 'Пошли'),
(2, 1, 'Силач', '2015-12-11', 'Стоять');
...
VALUES
(2, 2, 'Мудрец', '2022-10-11', 'Присядь'),
(2, 2, 'Султан', '2021-07-18', 'Пошли'),
(2, 2, 'Агор', '2017-12-17', 'Встань');
...
VALUES
(2, 3, 'Гоша', '2016-09-11', 'Присядь'),
(2, 3, 'Царь', '2011-05-15', 'Пошли'),
(2, 3, 'Серый', '2021-10-17', 'Встань');
